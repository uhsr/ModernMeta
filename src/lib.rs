...
#[derive(Debug)]
pub struct ModernMetaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModernMetaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModernMeta processing");
    
    let mut processor = ModernMetaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModernMetaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModernMetaProcessor::new(false);
